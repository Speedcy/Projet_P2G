...
disp(" ")
disp("<strong>Ajustement de puissance réactive</strong>")
disp(" ")
%point
...
disp(" ")
disp(strcat("Cout des travaux évités par le P2G (marge ",num2str(100*margin),"%) : ",num2str(round(cout_Q,2))," M€"))
...
disp(strcat("Cout des travaux évités par le P2G (marge ",num2str(100*margin),"%) : ",num2str(round(cout_ligne,2))," M€"))
...
disp(strcat("<strong>Cout total des travaux évités par le P2G (marge ",num2str(100*margin),"%) : </strong>",num2str(round(cout_total,1))," M€"))
