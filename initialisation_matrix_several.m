...
CO2_evite=power_gaz*180;

out_gaz=sim('ReseauGaz',3600);
disp(k)

A = [season; alpha; beta; gamma; loss; surplus; power_ptg; loss2; surplus2; power_gaz; Ctot_gaz; stock;CO2_evite];
A = A';
file = fopen('save_results_with_CO2.txt', 'a');
